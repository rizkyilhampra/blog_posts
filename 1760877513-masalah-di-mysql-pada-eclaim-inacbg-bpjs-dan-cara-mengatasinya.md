...
> Yap, jika ada yang berencana untuk *targeting attack* ke suatu rumah sakit, cara pertama yang bisa dilakukan adalah cari di mana ECLAIM berada. Tidak sedikit dari rumah sakit yang juga melakukan *tunneling* untuk *expose* aplikasi ini ke internet (umumnya menggunakan *service* dari ngrok). sebuah kritikan juga untuk pihak penyedia sistem atau aplikasi ini.  
